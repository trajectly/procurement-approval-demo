...
1. Canonical deep-dive with full observed outputs lives in this repo (`procurement-approval-demo`).
2. `trajectly/trajectly-action` README keeps the concise pass/fail E2E snippet and links back here for full walkthrough details.
